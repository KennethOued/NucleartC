...
<<<<<<< HEAD
salleDeControle::salleDeControle() : central()
{}

void salleDeControle::display_and_run(sdl2::window fenêtre)
{
	...
	reacteur* react = central.get_reacteur();
	double taux_b = react->get_TBeff();
	...
	double etat_b = react->get_Ebarre();
	std::string etat_barre = std::to_string(etat_b);

	//Pour le circuit primaire
	circuit_prim* circuitprimaire = central.get_circuit_prim();
...
<<<<<<< HEAD
    fenêtre << phrase1<< phrase2 << phrase3 << phrase4
=======
...
void salleDeControle::action_touche_1(sdl2::window fenêtre){

	circuit_prim* circuitprimaire = central.get_circuit_prim();
	pompe pompe_1 = circuitprimaire->get_pompe();
...
<<<<<<< HEAD
    ...
    // Charge une image fleche
    	...
    	sdl2::texte phrase2("Q pour fermer", fonte_texte, fenêtre, {0x00,0xFF,0xFF,0xFF});
    	phrase.at(580,640);

    	fenêtre << phrase << phrase2 << rendement << fleche
            << sdl2::flush;
...
<<<<<<< HEAD
void salleDeControle::action_touche_2(sdl2::window fenêtre){

	circuit_sec* circuitsecondaire = central.get_circuit_sec();
	pompe pompe_2 = circuitsecondaire->get_pompe();
...
<<<<<<< HEAD
void salleDeControle::action_touche_R(sdl2::window fenêtre){

	circuit_sec* circuitsecondaire = central.get_circuit_sec();
	condensateur pompe_c = circuitsecondaire->get_condensateur();
	//pompe pompe_c = condens.get_pompe();
	double r_p = pompe_c.get_regime_pompe();
	std::string regime_p = std::to_string(r_p);
...
<<<<<<< HEAD
void salleDeControle::action_touche_Tab(sdl2::window fenêtre){
