...
{}
  ...
  double d;
    double T1 = circuitprim.get_tempeaucircuit();
    if (T1 >= 420 && TXgr > 0.2)
    {

      Ebarre -= genrand2(generator);
  ...
  void  reacteur::equ_Ebore(const circuit_prim &circuitprim)
  {
    ...
    double d;
    double T1 = circuitprim.get_tempeaucircuit();
    double EC1 = circuitprim.get_etat_circuit();
    if (T1 >= 50 && Ecuve < 0.5 && EC1<0.5)
    { 
      d=genrand4(generator);
      if(d< 0.5)
      {
        Ebore -=genrand1(generator);
      }
  ...
  void  reacteur::equ_Ecuve(const circuit_prim &circuitprim)
  {
    ...
    std::uniform_real_distribution<double> genrand1(0.,0.02);
    std::uniform_real_distribution<double> genrand2(0.,0.03);
    std::uniform_real_distribution<double> genrand3(0.,0.06);
    std::uniform_real_distribution<double> genrand4(0.,1.);
    double d;
    double T1 = circuitprim.get_tempeaucircuit();
    double EC1 = circuitprim.get_etat_circuit();
  ...
  void reacteur::equ_Episc(const circuit_prim &circuitprim)
  {
    std::random_device hgenerator;
    std::default_random_engine generator(hgenerator());
    std::uniform_real_distribution<double> genrand1(0.,0.06);
    std::uniform_real_distribution<double> genrand4(0.,1.);
    double d;
    double T1 = circuitprim.get_tempeaucircuit();
    double EC1 = circuitprim.get_etat_circuit();
  ...
  void  reacteur::equ_Ecanaux(const circuit_prim &circuitprim)
  {
    std::random_device hgenerator;
    std::default_random_engine generator(hgenerator());
    std::uniform_real_distribution<double> genrand1(0.,0.05);
    std::uniform_real_distribution<double> genrand4(0.,1.);
    double d;
    double T1 = circuitprim.get_tempeaucircuit();
...
void reacteur::equ_Rpisc(const circuit_prim &circuitprim)
{
    std::random_device hgenerator;
    std::default_random_engine generator(hgenerator());
    std::uniform_real_distribution<double> genrand1(0.,45);
    double R1 = circuitprim.get_radioactivite();
    Rpisc = (1. - Ecuve)*R1 + 100. + genrand1(generator);

}


void reacteur::equ_barres( double valeur_demandee)
{
...
void reacteur::equ_bore( double valeur_demandee)
{
...
void reacteur::increment_ou_decrement_bore()
{
  if (TXb > TBeff)
  {
    TBeff += 0.01;
