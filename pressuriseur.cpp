...
void pressuriseur::set_etat_press(double valeur_demandee)
{
	etat_press=valeur_demandee;
}


void pressuriseur::set_etat_resistance_press(double valeur_demandee)
{
	etat_resistance_press=valeur_demandee;
}


void pressuriseur::set_T_press_demande(double valeur_demandee)
{
	T_press_demande=valeur_demandee;
}

void pressuriseur::set_T_press_actuel(double valeur_demandee)
{
