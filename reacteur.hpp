...
<<<<<<< HEAD
        void  equ_Ebarre(const circuit_prim& circuitprim );

        void  equ_Ebore(const circuit_prim& circuitprim);


        void  equ_Ecuve(const circuit_prim& circuitprim);


        void equ_Episc(const circuit_prim& circuitprim);


        void  equ_Ecanaux(const circuit_prim& circuitprim);

        void equ_Rpisc(const circuit_prim& circuitprim);

        void equ_barres( double valeur_demandee);

        void increment_ou_decrement_barres();

        void equ_bore( double valeur_demandee);

        void increment_ou_decrement_bore();

        reacteur& operator = (const reacteur&) = default;
=======
